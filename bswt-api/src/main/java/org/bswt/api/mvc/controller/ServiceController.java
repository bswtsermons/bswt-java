...
public class ServiceController 
{
	...
	public ResponseEntity<Service> getByDateAndSerial(@RequestParam @DateTimeFormat(pattern="yyyy-MM-dd") Date date, @PathVariable @RequestParam int series)
	{
	...
	public ResponseEntity<Void> create(@RequestBody Service service, UriComponentsBuilder uriComponentsBuilder)
	{
		...
		{
            LOGGER.info(String.format("duplicate service with date %s and series %s", service.getDate(), service.getSeries()));
